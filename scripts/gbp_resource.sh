...
function  update()
{
    ...
    then
        ...
        echo -e $vipid
        gbp policy-rule-set-update WEB-PRS --policy-rules "ICMP-ALLOW-PR TCP-ALLOW-PR FW-LB-PR"
...
function pre_create()
{
    ...
    then
        ...
        gbp external-policy-create --external-segments $ext_segment --consumed-policy-rule-sets=HTTP-LB-REDIRECT-PRS  EXTERNAL-WORLD
        dynamicinsertion $1 
